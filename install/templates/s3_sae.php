      ...
      <div class="server">
        <table width="100%">
          ...
          <tr>
            ...
            <td><input type="text" name="dbprefix" id="dbprefix" disabled="disabled" value="sp_" class="input"></td>
            <td><div id="J_install_tip_dbprefix"><span class="gray">建议使用默认，同一数据库安装多个XiaocaoCMS时需修改</span></div></td>
          </tr>
        </table>
		<table width="100%">
          <tr>
          ...
          <tr>
            ...
            <td><input type="text" name="sitename" value="小草淘宝客" class="input"></td>
          ...
          <tr>
            <td class="tar">关键词：</td>
            <td><input type="text" name="sitekeywords" value="XiaocaoCMS,php,内容管理框架,cmf,cms, xiaocaocms,framework" class="input" autoComplete="off"></td>
            <td><div id="J_install_tip_sitekeywords"></div></td>
          </tr>
          <tr>
            <td class="tar">描述：</td>
            <td><input type="text" name="siteinfo" class="input" value="XiaocaoCMS是小草网络科技发布的一款用于快速开发的内容管理框架"></td>
