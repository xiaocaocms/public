...
define('DISCUZ_ROOT', '../');
define('XIAOCAOCMS_AUTH', 'xiaocaocms_auth');
...
class uc_note {
	...
	function synlogin($get, $post) {
		...
		_setcookie(XIAOCAOCMS_AUTH, _authcode($uid."\t".$username, 'ENCODE'));
	}
	...
	function synlogout($get, $post) {
		...
		//note 同步登出 API 接口
		header('P3P: CP="CURa ADMa DEVa PSAo PSDo OUR BUS UNI PUR INT DEM STA PRE COM NAV OTC NOI DSP COR"');
		//_setcookie(XIAOCAOCMS_AUTH, '', -86400 * 365);
		_setcookie(XIAOCAOCMS_AUTH, '');
	}
